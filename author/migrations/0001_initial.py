    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent_node', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='parent_resource', to='author.Resource', verbose_name='父节点')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('create_date', models.DateTimeField(blank=True, default=datetime.datetime(2016, 3, 30, 20, 28, 43, 331986), verbose_name='创建时间')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('reg_date', models.DateTimeField(blank=True, default=datetime.datetime(2016, 3, 30, 20, 28, 43, 327982), verbose_name='注册时间')),
